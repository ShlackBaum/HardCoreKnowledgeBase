...
### Структура папок
Новая структура базы знаний (Декабрь 2025). Все папки используют кириллические названия.
...
│   └── как-здесь-работать.md
│
├── наши-принципы/
│   ├── философия-работы.md
│   ├── взаимодействие-в-команде.md
│   └── портрет-seo-эксперта.md
│
├── жизненный-цикл-проекта/
│   ├── контекст-продаж-и-pre-sale/
│   │   └── deep-research.md <-- Эталонный регламент Deep Research
│   ├── вход-проекта.md
│   ├── первый-созвон.md
│   ├── операционный-ритм.md
│   └── бизнес-контекст-счета-и-бухгалтерия.md
│
├── реальная-стратегия/
│   ├── формирование-стратегии.md
│   ├── приоритеты.md
│   ├── библиотека-сценариев.md
│   └── динамическое-планирование.md
│
├── архитектура-проекта/
│   ├── коммерческие-страницы.md
│   ├── влиятельные-служебные-страницы.md
│   └── инфо-страницы.md
│
├── структура-страниц/
│   ├── текстовая-оптимизация.md
│   ├── кндрк-и-кф.md
│   └── внедрение-изменений.md
│
├── аудит-проекта/
│   ├── критические-слэш-регулярные-проверки.md
│   ├── стандартные-проверки.md
│   ├── дополнительные-проверки.md
│   └── другие-факторы.md
│
├── опциональные-работы-и-проверки/
│   ├── конверсионный-анализ.md
│   ├── работа-со-сниппетами.md
│   └── работа-с-колдунщиками.md
│
├── опциональные-услуги/
│   ├── поведенческие-факторы.md
│   └── ссылочное-продвижение.md
│
├── взаимодействие-с-подрядчиками-и-исполнителями-клиента/
│   ├── работа-с-подрядчиками-и-командой-клиента.md
│   └── аргументация-и-контроль.md
│
├── арсенал/
│   ├── промпты.md
│   ├── сервисы-и-скрипты.md
│   └── доступы-и-реквизиты.md
│
